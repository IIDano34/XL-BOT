...
const embed = new Discord.RichEmbed()
   .setAuthor(`XL Bot Joined a Server ✅`)
   .setDescription(`**
...
client.on('guildDelete', guild => {
  client.channels.get("518350655056904202")
const embed = new Discord.RichEmbed()
   .setAuthor(`XL Bot left a server ❎`)
   .setDescription(`**
Server name: __${guild.name}__
Server id: __${guild.id}__
Server owner: __${guild.owner}__
...
2  !date | يقلك التاريخ
3  !new | انشاء تكذرة
4  !avatar | يظهرلك صورتك او صورة غيرك
5  !server | يظهر لك معلومات السيرفر
6  !id | يظهر لك معلوماتك
7 !members | يظهر لك معلومات اللاعبين
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
اضغط ▶ 	لتذهب الي قائمة اوامر الادارة`
,`
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
...
const bannedwords = [    "يا وصخ",    "يا كلب",    "يا حيوان",    "fuck you",    "يا خرا",    "يا غبي"  ];
